...
Главное отличие команды rebase от команды merge это то, что команда merge выполнятется из ветки, в КОТОРУЮ необходимо слить информацию, а команда rebase из ветки, ИЗ КОТОРОЙ информацию необходимо слить в конечную ветку. 